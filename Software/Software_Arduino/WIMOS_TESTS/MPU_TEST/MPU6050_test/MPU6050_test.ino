...
void setup(){
  ...
  */
  ...
  SerialUSB.println("MPU-6050 6-Axis");
...
// }
// for(int j = 0; j < 16; j++){
// SerialUSB.print(echoback[j], HEX);
// }
...
// SerialUSB.println(fifoCountL, DEC);
...
//
// for(int i = 0; i<10; i++){
// SerialUSB.print(receivedInts[i], DEC); SerialUSB.print(" ");
// }
// SerialUSB.println();
...
// SerialUSB.println(temp);
  ...
  if(aByte == 0x68){
  SerialUSB.println("Found MPU6050");
  }
  else{
   SerialUSB.println("Didn't find MPU6050");
  }
}
...
void sendQuat(){
  ...
  byte button = 0x00;
  SerialUSB.print("$"); SerialUSB.print(packetType);
  for(byte i = 0; i < 8; i++){
    SerialUSB.print(processed_packet[i]);
  }
  SerialUSB.print(button); SerialUSB.print(packetCount);
  SerialUSB.print("\r\n");
...
void sendPacket(){
  for(byte i = 0; i < fifoCountL-1; i++){
    SerialUSB.print(received_packet[i], HEX); SerialUSB.print(" ");
  }
  SerialUSB.println(received_packet[fifoCountL-1], HEX); SerialUSB.println();
}
